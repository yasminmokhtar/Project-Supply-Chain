# Supply Chain Analysis & Visualization Project
...
- **Fact Table:** `Fact_SupplyChain` (Costs, Availability, Defect Rates, etc.).
- **Dimension Tables:** `Dim_Products`, `Dim_Customers`, `Dim_Location`, `Dim_Transportation`, `Dim_ShippingCarriers`.
